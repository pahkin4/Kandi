...
%
\author{Ville Silvonen}
\title{\todo{Kandityön otsikko}} % primary title (for front page)
\titleB{Otsikko}     % translated title for abstract
\thesistype{Kandidaatintyö} % or Bachelor of Science, Laboratory Report... 
\examiner{Leena Partanen} % without title Prof., Dr., MSc or such

% Put your thesis' main language last
% http://mirrors.ctan.org/macros/latex/required/babel/base/babel.pdf
\usepackage[english, main=finnish]{babel}
...
\begin{spacing}{1.0}
         ...
         \textsf{Pääaine: }\\
         \textsf{Tarkastajat: \@examiner}\\ % automated, if just 1 examiner
         \textsf{Avainsanat: }\\
\end{spacing}
...
\nomenclature[L]{\textbf{OP}}{original poster}
\nomenclature[S]{$h$}{Plank constant}
\nomenclature[S]{$c$}{speed of light in vacuum}
\nomenclature[L]{\textbf{IMO}}{in my opinion}
...
% \item [SI system]  Syst\`eme international d'units, International System of Units
...
\begin{figure}[ht]
    ...
    \draw[black,interface](-2.1,0)--(2.1,0);
    \filldraw[fill=blue!20!white, draw=blue!40!black](1,0) arc (-20:200:1) -- cycle;
    \draw[black](1,0) -- ++(70:2);
    \draw[black](2,0) arc (0:70:1) ;
    \path(1,0)++(35:1.3) node{$\theta$};
    \end{tikzpicture}
    }
    
    \subfigure[Hydrofiilinen pinta]{
    \begin{tikzpicture}[
    x=2cm,y=2cm,
    interface/.style={
        postaction={draw,decorate,decoration={border,angle=-45,
    ...
    \draw[black,interface](-2.1,0)--(2.1,0);
    \filldraw[fill=blue!20!white, draw=blue!40!black](1,0) arc (20:160:1) -- cycle;
    \draw[black](1,0) -- ++(110:2);
    \draw[black](2,0) arc (0:110:1);
    \path(1,0)++(35:1.3) node{$\theta$};
    \end{tikzpicture}
    }
    
    \caption{Kontaktikulma, TikZ harjoittelua}
    \label{fig:my_label}
\end{figure}
